...
<head>
    ...
    <title>Admin Dashboard - Ecom</title>
    ...
    <div class="flex h-screen">
        ...
        <aside class="w-64 bg-white border-r border-gray-200 flex flex-col">
            <div class="h-16 flex items-center justify-center border-b border-gray-200">
                <h1 class="text-2xl font-bold text-green-600">LuxeStore Admin</h1>
            </div>
        ...
        <main class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6">
                ...
                <div class="flex items-center">
                    <span class="text-sm text-gray-500 mr-4">Admin User</span>
                    <div
                        class="h-8 w-8 bg-green-100 rounded-full flex items-center justify-center text-green-600 font-bold">
                        A</div>
                </div>
            </header>
